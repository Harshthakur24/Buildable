...
const List = () => {
  ...
  return (
    <div className='flex bg-[rgb(32,32,46)] min-h-[500px] pt-[200px] pb-[50px] transition-colors duration-450 w-[100%] items-center flex-col ll:gap-y-[40px]'>
        ...
        <div className='Laundry_List flex min-h-[110px] max-w-[800px] ll:w-[70%] ss:w-[80%]  items-center flex-col gap-y-[23px] '>
            {
              ListContent.map((list,index) => (
                <div key={index} className='laundry_Row relative flex  ll:min-h-auto  gg:h-[93px] ll:h-[70px] mm:h-[55px] ss:h-[34px]  w-[100%] items-center'>
                  <div style={{
        ...
        <div className='flex gg:flex-row flex-col ll:pt-[70px] ss:pt-[120px] min-h-[400px] w-[70%] gg:items-start mm:items-center gg:justify-center mm:justify-start gap-[100px] mm:gap-[40px] ll:gap-[60px]'>
          {ListFooter.map((list,index) => (
            ...
            <div className='flex pr-[20px] min-h-[30px] w-[100%] items-center'>
              <div className='flex pr-[30px] mr-[30px] min-w-[50px] items-center justify-between border-r-[1px] border-r-solid border-r-[#ffffff1a]'>
                <img src={list.imgUrl} alt={list.text} className='inline-block max-h-[24px] align-middle' />
              </div>
              <div className='font-semibold text-[14px] mr-[10px] text-[#dedeeb]'>{list.text}</div>
              <img src="https://cdn.prod.website-files.com/625593a881b8ebd169835ca5/65ea2435fd6146695bc650dd_arrow.svg" alt="Arrow icon" loading='lazy' />
            </div>
